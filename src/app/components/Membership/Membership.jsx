...
const Membership = () => {
    return (
        <div className="mx-5 py-32" id="membership">
            ...
            <p className="max-w-[718px] mx-auto text-2xl text-center">If a $500 golf ball isn’t enough, you can improve our margins further by kindly providing us with recurring revenue.</p>
